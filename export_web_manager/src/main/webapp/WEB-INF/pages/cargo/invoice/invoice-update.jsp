...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="all-order-manage-list.html">修改发票</a></li>
            ...
            <form id="editForm" action="${ctx}/cargo/invoice/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                            ...
                            <input type="text" placeholder="createBy"  name="createBy" class="form-control pull-right"
...
<%--                                &lt;%&ndash;                            <td class="sorting">日期</td>&ndash;%&gt;--%>
<%--                            </tr>--%>
<%--                            </thead>--%>
<%--                            <tbody>--%>
<%--                            --%>
<%--                                <tr>--%>
<%--                                    <td><input type="radio" name="id" onclick="checkAll(id)" value="${ship.shippingOrderId}"/></td>--%>
