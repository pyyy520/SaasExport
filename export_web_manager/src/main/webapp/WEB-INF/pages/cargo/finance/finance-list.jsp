...
<script>
    function deleteById() {
        ...
        if(id) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/cargo/finance/delete.do?id="+id;
            }
        }else{
    ...
    function submit() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/cargo/finance/submit.do?id="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
    ...
    function cancel() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/cargo/finance/cancel.do?id="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
    ...
    function exportE() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/cargo/finance/edit.do?id="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
