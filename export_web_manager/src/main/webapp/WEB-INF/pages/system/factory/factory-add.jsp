                            ...
                            <div class="tab-pane active" id="tab-form">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="厂家类型" name="ctype" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">厂家全称</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="厂家全称" name="fullName" value="${factory.factoryName}">
                                    </div>
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="联系人"   name="contacts" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">电话</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="电话"     name="phone" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">手机</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="手机"     name="mobile" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">传真</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="传真"     name="fax" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">地址</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="地址"     name="address" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">验货员</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="验货员"   name="inspector" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">说明</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="说明"     name="remark" value="${factory.factoryName}">
                                    </div>
                                    <div class="col-md-2 title">排序号</div>
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="排序号"   name="orderNo" value="${factory.factoryName}">
                                    </div>
