...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/system/user/list.do">商品列表</a></li>
        </ol>
    </section>
    <!-- 内容头部 /-->
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/system/product/edit.do" method="post">
                <input type="hidden" id="id" name="id" value="${product.id}">
                <input type="hidden" id="productName" name="productName" value="${product.productName}">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">商品名称</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="商品名称" name="productName" value="${product.productName}">
                    </div>

                    <div class="col-md-2 title">所在工厂</div>
                    <div class="col-md-4 data">
                        <select class="form-control" onchange="document.getElementById('productName').value=this.options[this.selectedIndex].text" name="productId">
                    ...
                    <div class="col-md-2 title">照片</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="照片" name="productImage" value="${product.productImage}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="厂家简称" name="factoryName" value="${product.factoryName}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="包装" name="packing" value="${product.packing}">
                    </div>
                    ...
                    <div class="col-md-2 title">大箱尺寸长</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="大箱尺寸长" name="mpsizeWidth" value="${product.mpsizeWidth}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="创建人" name="createBy" value="${product.createBy}">
                    </div>
                </div>
            </form>
        </div>
